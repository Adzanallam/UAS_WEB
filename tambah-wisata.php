          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav ml-auto">
              <li class="nav-item active">
                <a class="nav-link" href="menu-utama.php">Beranda</a>
              </li>
            ...
            <div class="col-md-8">
                <div class="card text-left">
                    ...
                    <div class="card-body justify-content-center">
                        <form action="tambahwisatacontroller.php" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="name" id="name" aria-describedby="emailHelp" placeholder="Masukkan Nama">
                            </div>
                            <div class="form-group">
