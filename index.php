  ...
  <body>
    ...
    <!-- Awal Jumbroton -->
      <div class="jumbotron warna-bg">
        ...
        <a class="btn btn-secondary btn-lg" href="selengkapnya-un.php" role="button">Selengkapnya..</a>
    </div>
    <!-- Akhir Jumbroton -->
        ...
        <div class="col-md-3 mb-2 ">
          <div class="card">
            ...
            <div class="card-body">
              ...
              <h6 class="card-text"><a href="show-wisata-un.php?id=<?= $wisata[$i]['id_wisata'] ?>" class="text-primary"><?php echo substr($wisata[$i]['about'], 0, 40) . "..." ?></a></h6>
